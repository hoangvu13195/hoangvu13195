                        ...
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr class="active">
                                    ...
                                    <td><?php echo $book; ?></td>
                                    <td class="text-center"><a href="read.php?file=<?php echo $file; ?>"><i class="fas fa-eye"></i></a></td>
                                    <td class="text-center"><a href="download.php?file=<?php echo $file; ?>"><i class="fa fa-download"></i></a></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
